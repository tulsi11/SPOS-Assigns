...
public class MacroP2 {
	...
	public static void main(String[] args) throws Exception {
		BufferedReader irb=new BufferedReader(new FileReader("C:\\Users\\Tulsi Chopade\\Desktop\\SPOS\\assign_2\\macro_p1_intermediate.txt"));
		BufferedReader mdtb=new BufferedReader(new FileReader("C:\\Users\\Tulsi Chopade\\Desktop\\SPOS\\assign_2\\mdt.txt"));
		BufferedReader kpdtb=new BufferedReader(new FileReader("C:\\Users\\Tulsi Chopade\\Desktop\\SPOS\\assign_2\\kpdt.txt"));
		BufferedReader mntb=new BufferedReader(new FileReader("C:\\Users\\Tulsi Chopade\\Desktop\\SPOS\\assign_2\\mnt.txt"));
		
		FileWriter fr=new FileWriter("C:\\Users\\Tulsi Chopade\\Desktop\\SPOS\\assign_2\\macro_pass2.txt");
